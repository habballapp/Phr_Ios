      ...
      () => {
        refTemp
          ...
          .then(function (downloadURL) {
            firebase
              .database()
              .ref(`Register_User/${userID}/PersonalHistory`)
              .set({
            ...
            <Scrollview>
              <Container
                ...
                <Container
                  ...
                  <Textview
                    textStyle={{width: '40%', fontSize: 18, color: '#767981'}}>
                    Voice Note:
                  </Textview>
                  <Button
                    title="Upload"
                    style={style.loginButtonStyles2}
                    textStyle={styles.insuranceButtonText}
                    onPress={() => this.attachFile()}>
                    <FontAwesome name="upload" size={15} color="blue" />
                  </Button>
                </Container>
              ...
              <Button
                ...
                title="Submit"
                style={style.loginButtonStyles1}
                textStyle={styles.insuranceButtonText}>
                <FontAwesome name="upload" size={15} color="white" />
              </Button>
            </Scrollview>
          </SafeViewArea>
        </Container>
